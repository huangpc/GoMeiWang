	...
	<div id="mainbody">
		<div id="main_fa">
			...
			<div id="main_fa_r"><!-- 展示图 -->
				<div id="main_fa_r_1">
					<div class="hd">
						<ul>
							<li><div><span class="title">韩式双眼皮</span><span class="intro">开启心灵的窗口</span></div></li>
							<li><div><span class="title">隆鼻术</span><span class="intro">时尚 顶尖技术</span></div></li>
							<li><div><span class="title">下巴整修</span><span class="intro">一招让你瘦下来</span></div></li>
							<li><div><span class="title">隆胸</span><span class="intro">找回女人的自信</span></div></li>
							<li><div><span class="title">胶原蛋白</span><span class="intro">源自韩国的技术</span></div></li>
						</ul>
					</div>
					<div class="bd">
						<ul>
							<li>
								<div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image001.jpg" /></a></div>
							</li>
							<li>
								<div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image002.jpg" /></a></div>
							</li>
							<li>
								<div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image003.jpg" /></a></div>
							</li>
							<li>
								<div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image004.jpg" /></a></div>
							</li>
							<li>
								<div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image002.jpg" /></a></div>
							</li>
				...
				<div id="main_fa_r_2">
					<div id="main_fa_r_2_l">
						<div class="content">
							<span>当日热门话题</span>
							<p>避免盲目整形的六大建议避免盲目整形的六大建议避免盲目整形的六大建议避免盲目整形的...</p>
							<ul>
								<li><a href="#">激光治疗各种胎记</a></li>
								<li><a href="#">宝宝常出现的血管瘤症状有哪些</a></li>
								<li><a href="#">自体脂肪注射在面部年轻化中的应用</a></li>
								<li><a href="#">自体脂肪注射在面部年轻化中的应用</a></li>
							</ul>
						</div>
						<div class="content">
					...
					<div id="main_fa_r_2_hospital">
						...
						<div class="bd">
							<ul>
								<li><a href="#"><img src="<%= basePath %>resources/images/mainbody/hos1.jpg" /></a></li>
								<li><a href="#"><img src="<%= basePath %>resources/images/mainbody/hos2.jpg" /></a></li>
								<li><a href="#"><img src="<%= basePath %>resources/images/mainbody/hos3.jpg" /></a></li>
								<li><a href="#"><img src="<%= basePath %>resources/images/mainbody/hos4.jpg" /></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div id="main_tou">
			<div id="main_tou_l"><!-- 签约明星&热门精选 -->
				<div id="main_tou_l_1">
					...
					<div id="main_tou_l_1_content">
						<div class="bd">
							<ul class="picList">
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image006.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image007.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image008.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image009.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image010.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image008.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image006.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image010.jpg" /></a></div></li>
								<li><div class="pic"><a href="#"><img src="<%= basePath %>resources/images/mainbody/image007.jpg" /></a></div></li>
			...
			<div id="main_tou_r">
				...
				<a href="#" class="ad"><img src="<%= basePath %>resources/images/mainbody/ad1.jpg"></a>
				<a href="#" class="ad"><img src="<%= basePath %>resources/images/mainbody/ad2.jpg"></a>
				<a href="#" class="ad"><img src="<%= basePath %>resources/images/mainbody/ad4.jpg"></a>
				<a href="#" class="ad"><img src="<%= basePath %>resources/images/mainbody/ad5.jpg"></a>
